...
class HomeController extends Controller
{
    public function __invoke()
    {
      ...
      //Acceder a 6 servicios home
        ...
        return view('home', compact('datos', 'datoscliente', 'cualidades', 'datoscliente2', 'datoscliente3', 
        'datoscliente4', 'datoscliente1','datoscliente5','dservicios','iconservicios1','iconservicios2','iconservicios3',
        'iconservicios4','iconservicios5','iconservicios6','datos1','cualidades1','cualidades2','cualidades3','cualidades4'));
    }
}
